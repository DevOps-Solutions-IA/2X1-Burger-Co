      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-2.5rem)] max-w-6xl items-start lg:items-center gap-6 lg:gap-12 lg:grid-cols-[1fr_420px]">
        ...
        <main className="flex items-center justify-center px-1 sm:px-4">
          <Card className="relative w-full max-w-lg overflow-hidden border-brand-500/20 bg-black p-8 text-stone-50 lg:p-10">
            ...
            <h1 className="mt-3 text-[1.9rem] font-bold text-white">Turno de domicilios</h1>
            <p className="mt-2 text-base leading-6 text-stone-300">Ingresa con tu nombre y código para gestionar las entregas asignadas.</p>
            ...
            <form className="mt-8 space-y-5" onSubmit={handleSubmit(async (values) => {
              ...
              <div>
                ...
                <Input id={nameId} data-testid="delivery-login-name" {...register('name')} placeholder="Tu nombre de acceso"
              ...
              <div>
                ...
                <Input id={accessCodeId} data-testid="delivery-login-code" {...register('accessCode')} type="password" placeholder="Ingresa tu código"
              ...
              <Button data-testid="delivery-login-submit" type="submit" size="lg" className="w-full" disabled={isSubmitting || loading} aria-busy={isSubmitting}>
