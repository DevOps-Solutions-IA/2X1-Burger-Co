...
export function QueryState({
  ...
  if (status === 'loading') {
    return (
      <div className={cn('space-y-3 rounded-2xl border border-line bg-panel p-4', className)} role="status" aria-live="polite" aria-busy="true" aria-label={title ?? 'Cargando información'} data-testid={dataTestId}>
