...
import { CONSOLE_GLOW_OVERLAY_CLASS, CONSOLE_GRID_OVERLAY_CLASS, CONSOLE_SHELL_CLASS } from './console-theme';
 ...
 * Shell negro (`console-theme.ts`) — este es el único lugar de toda la
 * app con este fondo; el CRM y el resto del sistema (Inventario, POS,
 * Caja) permanecen en el tema claro de siempre.
 */
export function ControlTowerFrame({ children }: { children: ReactNode }) {
  return (
    <div className={CONSOLE_SHELL_CLASS} data-testid="sofia-control-tower">
      <div className={CONSOLE_GLOW_OVERLAY_CLASS} aria-hidden="true" />
