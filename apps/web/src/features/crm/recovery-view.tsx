  ...
  return (
    <div className="space-y-5">
      <section className="rounded-2xl border border-signal-warning/30 bg-signal-warning/10 p-5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between"><div className="flex max-w-3xl items-start gap-3"><ShieldAlert className="mt-0.5 h-5 w-5 shrink-0 text-signal-warning" /><div><h2 className="font-heading text-lg font-bold text-ink">Recuperación gobernada</h2><p className="mt-1 text-sm leading-6 text-muted">Las quejas y resoluciones permanecen en Customer Service. CRM organiza seguimiento, pero no autoriza reembolsos, descuentos, cupones ni reemplazos.</p></div></div><Button asChild variant="secondary"><Link href="/customer-service">Abrir casos <ArrowRight className="h-4 w-4" /></Link></Button></div>
      </section>
