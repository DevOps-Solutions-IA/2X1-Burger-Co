...
import { SectionHeading, StatusBadge } from '@/components/sofia';
...
export function ConversationDetailPanel({ conversation }: { conversation: SofiaInboxConversation | undefined }) {
  if (!conversation) {
    return (
      <Card data-testid="sofia-conversations-detail-empty" className="flex h-full items-center justify-center">
        <EmptyState
  ...
  return (
    <Card data-testid="sofia-conversations-detail" className="flex h-full flex-col">
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="flex items-center gap-1.5 text-[13.5px] font-bold text-ink">
              <User className="hidden h-4 w-4 shrink-0 text-stone-400 sm:block" aria-hidden="true" />
      ...
      <div className="mt-3 rounded-xl border border-brand-100 bg-brand-50/70 px-3.5 py-2.5">
        <p className="flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-brand-900">
      ...
      <div className="mt-4 min-h-0 flex-1">
        <SectionHeading icon={<MessageCircle className="h-4.5 w-4.5" />} title={`Mensajes (${conversation.messages.length})`} tone="ink" />
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <p className={cn('mt-1.5 text-[12.5px] leading-5', message.bodyPreview ? 'text-stone-800' : 'italic text-stone-600')}>
